...
typedef uint16_t BMDSwitcherAudioOutputId;
typedef uint32_t BMDSwitcherAudioRoutingSourceId;
typedef uint32_t BMDSwitcherAudioRoutingOutputId;
...
BMD_CONST REFIID IID_IBMDSwitcherTalkback                         = /* D7858656-1A95-4671-87E9-33216F4AE8BB */ { 0xD7,0x85,0x86,0x56,0x1A,0x95,0x46,0x71,0x87,0xE9,0x33,0x21,0x6F,0x4A,0xE8,0xBB };
...
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutputInputCallback = /* C825B474-B233-48A9-9E08-29CED79E1D33 */ { 0xC8,0x25,0xB4,0x74,0xB2,0x33,0x48,0xA9,0x9E,0x08,0x29,0xCE,0xD7,0x9E,0x1D,0x33 };
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutputInput     = /* 11320BE2-E3D9-4A63-AECD-D452EC71257F */ { 0x11,0x32,0x0B,0xE2,0xE3,0xD9,0x4A,0x63,0xAE,0xCD,0xD4,0x52,0xEC,0x71,0x25,0x7F };
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutputInputIterator = /* 58FABF18-013F-4E27-ACAC-463F84909305 */ { 0x58,0xFA,0xBF,0x18,0x01,0x3F,0x4E,0x27,0xAC,0xAC,0x46,0x3F,0x84,0x90,0x93,0x05 };
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutputCallback  = /* F9753E15-E3E9-4512-B45E-E07F743598E2 */ { 0xF9,0x75,0x3E,0x15,0xE3,0xE9,0x45,0x12,0xB4,0x5E,0xE0,0x7F,0x74,0x35,0x98,0xE2 };
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutput          = /* D25F08F5-9F0F-4577-B782-59BB19F227F0 */ { 0xD2,0x5F,0x08,0xF5,0x9F,0x0F,0x45,0x77,0xB7,0x82,0x59,0xBB,0x19,0xF2,0x27,0xF0 };
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioAuxOutputIterator  = /* 7189CC10-0D17-453B-A886-83D3F0B8FD63 */ { 0x71,0x89,0xCC,0x10,0x0D,0x17,0x45,0x3B,0xA8,0x86,0x83,0xD3,0xF0,0xB8,0xFD,0x63 };
...
BMD_CONST REFIID IID_IBMDSwitcherFairlightAudioMixer              = /* F112342E-B867-4BF9-B2E0-B3225E382552 */ { 0xF1,0x12,0x34,0x2E,0xB8,0x67,0x4B,0xF9,0xB2,0xE0,0xB3,0x22,0x5E,0x38,0x25,0x52 };
...
BMD_CONST REFIID IID_IBMDSwitcherRecordDiskIterator               = /* 5146441D-AAE0-47D5-9B83-64F2147E18E6 */ { 0x51,0x46,0x44,0x1D,0xAA,0xE0,0x47,0xD5,0x9B,0x83,0x64,0xF2,0x14,0x7E,0x18,0xE6 };
BMD_CONST REFIID IID_IBMDSwitcherRecordDisk                       = /* 51F00CF6-DDDF-4708-9BF7-B666699EBCCB */ { 0x51,0xF0,0x0C,0xF6,0xDD,0xDF,0x47,0x08,0x9B,0xF7,0xB6,0x66,0x69,0x9E,0xBC,0xCB };
...
BMD_CONST REFIID IID_IBMDSwitcherRemoteSourceIterator             = /* 347851E2-FF81-4622-A33E-4D4CCC5705C7 */ { 0x34,0x78,0x51,0xE2,0xFF,0x81,0x46,0x22,0xA3,0x3E,0x4D,0x4C,0xCC,0x57,0x05,0xC7 };
BMD_CONST REFIID IID_IBMDSwitcherRemoteSourceExternal             = /* A7FBDE6C-00B9-421B-9EC5-19BAEEAC6E49 */ { 0xA7,0xFB,0xDE,0x6C,0x00,0xB9,0x42,0x1B,0x9E,0xC5,0x19,0xBA,0xEE,0xAC,0x6E,0x49 };
BMD_CONST REFIID IID_IBMDSwitcherRemoteSourceExternalCallback     = /* EEB874B9-2A58-44DB-87E1-98866E58024D */ { 0xEE,0xB8,0x74,0xB9,0x2A,0x58,0x44,0xDB,0x87,0xE1,0x98,0x86,0x6E,0x58,0x02,0x4D };
...
BMD_CONST REFIID IID_IBMDSwitcherDisplayClockCallback             = /* 289EE0F2-D41F-4F2C-84E1-55C5B8FAA5F1 */ { 0x28,0x9E,0xE0,0xF2,0xD4,0x1F,0x4F,0x2C,0x84,0xE1,0x55,0xC5,0xB8,0xFA,0xA5,0xF1 };
BMD_CONST REFIID IID_IBMDSwitcherDisplayClock                     = /* 114A382F-9BD7-4E6D-9C5C-5ABB14BFBBFF */ { 0x11,0x4A,0x38,0x2F,0x9B,0xD7,0x4E,0x6D,0x9C,0x5C,0x5A,0xBB,0x14,0xBF,0xBB,0xFF };
BMD_CONST REFIID IID_IBMDSwitcherAudioRoutingSourceCallback       = /* E9124E37-82E0-4D21-BE2F-53ABEC6584D7 */ { 0xE9,0x12,0x4E,0x37,0x82,0xE0,0x4D,0x21,0xBE,0x2F,0x53,0xAB,0xEC,0x65,0x84,0xD7 };
BMD_CONST REFIID IID_IBMDSwitcherAudioRoutingSource               = /* 11204D7B-3E11-4CC1-B481-804C67E148F9 */ { 0x11,0x20,0x4D,0x7B,0x3E,0x11,0x4C,0xC1,0xB4,0x81,0x80,0x4C,0x67,0xE1,0x48,0xF9 };
BMD_CONST REFIID IID_IBMDSwitcherAudioRoutingSourceIterator       = /* 669AC7E4-D18B-4975-A2F9-29050858BA7D */ { 0x66,0x9A,0xC7,0xE4,0xD1,0x8B,0x49,0x75,0xA2,0xF9,0x29,0x05,0x08,0x58,0xBA,0x7D };
BMD_CONST REFIID IID_IBMDSwitcherAudioRoutingOutputCallback       = /* AB75D3DF-35A6-4134-946C-BB56BDADB454 */ { 0xAB,0x75,0xD3,0xDF,0x35,0xA6,0x41,0x34,0x94,0x6C,0xBB,0x56,0xBD,0xAD,0xB4,0x54 };
BMD_CONST REFIID IID_IBMDSwitcherAudioRoutingOutput               = /* DCA2A029-8E82-47D0-9D5A-CD46EB0D72DE */ { 0xDC,0xA2,0xA0,0x29,0x8E,0x82,0x47,0xD0,0x9D,0x5A,0xCD,0x46,0xEB,0x0D,0x72,0xDE };
...
enum _BMDSwitcherExternalPortType {
    ...
    bmdSwitcherExternalPortTypeRJ45                              = 0x00001000
};
...
enum _BMDSwitcherEventType {
    ...
    bmdSwitcherEventTypeColorimetryModeChanged                   = /* 'colm' */ 0x636F6C6D,
    bmdSwitcherEventTypeTimeCodeChanged                          = /* 'setc' */ 0x73657463,
    bmdSwitcherEventTypeTimeCodeLockedChanged                    = /* 'tclc' */ 0x74636C63,
    bmdSwitcherEventTypeTimeCodeExternalChanged                  = /* 'tcex' */ 0x74636578,
...
enum _BMDSwitcherTalkbackEventType {
    ...
    bmdSwitcherTalkbackEventTypeMicrophoneMutedChanged           = /* 'tmmC' */ 0x746D6D43
};
...
enum _BMDSwitcherFairlightAudioAuxOutputInputId {
    ...
    BMDSwitcherFairlightAudioAuxOutputInputIdEngineeringTalkback = /* 'aiiE' */ 0x61696945
};
...
enum _BMDSwitcherFairlightAudioAuxOutputEventType {
    ...
    bmdSwitcherFairlightAudioAuxOutputEventTypeDimLevelChanged   = /* 'adlC' */ 0x61646C43
};
...
enum _BMDSwitcherFairlightAudioMixerEventType {
    ...
    bmdSwitcherFairlightAudioMixerEventTypeMicTalkbackGainChanged = /* 'mtgC' */ 0x6D746743
};
...
enum _BMDSwitcherColorimetryMode {
    ...
    bmdSwitcherColorimetryModeRec2020_HLG                        = /* 'c22h' */ 0x63323268,
    bmdSwitcherColorimetryModeRec2020_PQ                         = /* 'c22p' */ 0x63323270,
    bmdSwitcherColorimetryModeAutomatic                          = /* 'cAut' */ 0x63417574
};
...
enum _BMDSwitcherRecordAVEventType {
    ...
    bmdSwitcherRecordAVEventTypeRecordingAvailabilityChanged     = /* 'rmav' */ 0x726D6176,
    bmdSwitcherRecordAVEventTypeISOAvailabilityChanged           = /* 'isav' */ 0x69736176
};
...
enum _BMDSwitcherRemoteSourceInternetStatusType {
    ...
    BMDSwitcherRemoteSourceInternetStatusInaccessible            = /* 'isnn' */ 0x69736E6E
};
...
enum _BMDSwitcherRemoteSourcePortStatusType {
    ...
    BMDSwitcherRemoteSourcePortStatusConfiguring                 = /* 'ipgc' */ 0x69706763,
    BMDSwitcherRemoteSourcePortStatusFailed                      = /* 'ipfg' */ 0x69706667
};
...
enum _BMDSwitcherHyperDeckEventType {
    ...
    bmdSwitcherHyperDeckEventTypeModelChanged                    = /* 'embC' */ 0x656D6243,
    bmdSwitcherHyperDeckEventTypeStorageMediaInfoChanged         = /* 'emeC' */ 0x656D6543
};
...
enum _BMDSwitcherDisplayClockEventType {
    ...
    bmdSwitcherDisplayClockEventTypePositionXChanged             = /* 'psxC' */ 0x70737843,
    bmdSwitcherDisplayClockEventTypePositionYChanged             = /* 'psyC' */ 0x70737943,
    bmdSwitcherDisplayClockEventTypeAutoHideChanged              = /* 'auhC' */ 0x61756843,
    bmdSwitcherDisplayClockEventTypeStartFromChanged             = /* 'strC' */ 0x73747243,
    bmdSwitcherDisplayClockEventTypeClockModeChanged             = /* 'typC' */ 0x74797043,
    bmdSwitcherDisplayClockEventTypeClockStateChanged            = /* 'staC' */ 0x73746143,
    bmdSwitcherDisplayClockEventTypeClockTimeChanged             = /* 'timC' */ 0x74696D43
};
...
enum _BMDSwitcherAudioChannelPair {
    ...
    bmdSwitcherAudioChannelPair_7_8                              = 3,
    bmdSwitcherAudioChannelPair_9_10                             = 4,
    bmdSwitcherAudioChannelPair_11_12                            = 5,
    bmdSwitcherAudioChannelPair_13_14                            = 6,
    bmdSwitcherAudioChannelPair_15_16                            = 7
};
...
enum _BMDSwitcherAudioInternalPortType {
    ...
    bmdSwitcherAudioInternalPortTypeEngineeringTalkbackMix       = /* 'aiet' */ 0x61696574,
    bmdSwitcherAudioInternalPortTypeProductionTalkbackMix        = /* 'aipt' */ 0x61697074,
    bmdSwitcherAudioInternalPortTypeMediaPlayer                  = /* 'aimp' */ 0x61696D70,
    bmdSwitcherAudioInternalPortTypeProgram                      = /* 'aipg' */ 0x61697067,
    bmdSwitcherAudioInternalPortTypeReturn                       = /* 'airt' */ 0x61697274,
    bmdSwitcherAudioInternalPortTypeMonitor                      = /* 'aimo' */ 0x61696D6F,
    bmdSwitcherAudioInternalPortTypeMadi                         = /* 'aimd' */ 0x61696D64,
    bmdSwitcherAudioInternalPortTypeAuxOut                       = /* 'aiao' */ 0x6169616F,
    bmdSwitcherAudioInternalPortTypeAudioAuxOut                  = /* 'aiaa' */ 0x61696161,
    bmdSwitcherAudioInternalPortTypeReturnStreaming              = /* 'airs' */ 0x61697273,
    bmdSwitcherAudioInternalPortTypeMixMinus                     = /* 'aimm' */ 0x61696D6D
};
...
class IBMDSwitcherFairlightAudioAuxOutputInputCallback;
class IBMDSwitcherFairlightAudioAuxOutputInput;
class IBMDSwitcherFairlightAudioAuxOutputInputIterator;
class IBMDSwitcherFairlightAudioAuxOutputCallback;
class IBMDSwitcherFairlightAudioAuxOutput;
class IBMDSwitcherFairlightAudioAuxOutputIterator;
...
class IBMDSwitcherRemoteSourceConfiguration;
class IBMDSwitcherRemoteSourceConfigurationCallback;
class IBMDSwitcherRemoteSource;
class IBMDSwitcherRemoteSourceCallback;
class IBMDSwitcherRemoteSourceIterator;
class IBMDSwitcherRemoteSourceExternal;
class IBMDSwitcherRemoteSourceExternalCallback;
...
class IBMDSwitcherDisplayClockCallback;
class IBMDSwitcherDisplayClock;
class IBMDSwitcherAudioRoutingSourceCallback;
class IBMDSwitcherAudioRoutingSource;
class IBMDSwitcherAudioRoutingSourceIterator;
class IBMDSwitcherAudioRoutingOutputCallback;
class IBMDSwitcherAudioRoutingOutput;
...
public:
    ...
    virtual HRESULT GetMicrophoneMuted (/* out */ bool* muted) = 0;
    virtual HRESULT SetMicrophoneMuted (/* in */ bool muted) = 0;
    virtual HRESULT CanMuteMicrophone (/* out */ bool* canMuteMicrophone) = 0;
...
public:
    ...
    virtual HRESULT GetMaxInputGain (/* out */ double* gain) = 0;
...
/* Interface IBMDSwitcherFairlightAudioAuxOutputInputCallback - Fairlight Audio Aux Output Input Object Callback */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutputInputCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherFairlightAudioAuxOutputInputEventType eventType) = 0;

protected:
    virtual ~IBMDSwitcherFairlightAudioAuxOutputInputCallback () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherFairlightAudioAuxOutputInput - Fairlight Audio Aux Output Input Object */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutputInput : public IUnknown
{
public:
    virtual HRESULT GetInputId (/* out */ BMDSwitcherFairlightAudioAuxOutputInputId* inputId) = 0;
    virtual HRESULT DoesSupportMute (/* out */ bool* supportsMute) = 0;
    virtual HRESULT GetGain (/* out */ double* decibel) = 0;
    virtual HRESULT SetGain (/* in */ double decibel) = 0;
    virtual HRESULT GetMute (/* out */ bool* mute) = 0;
    virtual HRESULT SetMute (/* in */ bool mute) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherFairlightAudioAuxOutputInputCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherFairlightAudioAuxOutputInputCallback* callback) = 0;
};

/* Interface IBMDSwitcherFairlightAudioAuxOutputInputIterator - Fairlight Audio Aux Output Input Iterator */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutputInputIterator : public IUnknown
{
public:
    virtual HRESULT Next (/* out */ IBMDSwitcherFairlightAudioAuxOutputInput** auxOutputInput) = 0;

protected:
    virtual ~IBMDSwitcherFairlightAudioAuxOutputInputIterator () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherFairlightAudioAuxOutputCallback - Fairlight Audio Aux Output Object Callback */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutputCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherFairlightAudioAuxOutputEventType eventType) = 0;

protected:
    virtual ~IBMDSwitcherFairlightAudioAuxOutputCallback () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherFairlightAudioAuxOutput - Fairlight Aux Output Object */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutput : public IUnknown
{
public:
    virtual HRESULT GetOutputId (/* out */ BMDSwitcherFairlightAudioAuxOutputId* outputId) = 0;
    virtual HRESULT DoesSupportMute (/* out */ bool* supportsMute) = 0;
    virtual HRESULT DoesSupportDim (/* out */ bool* supportsDim) = 0;
    virtual HRESULT GetGain (/* out */ double* decibel) = 0;
    virtual HRESULT SetGain (/* in */ double decibel) = 0;
    virtual HRESULT GetDimOn (/* out */ bool* dimOn) = 0;
    virtual HRESULT SetDimOn (/* in */ bool dimOn) = 0;
    virtual HRESULT GetDimLevel (/* out */ double* dimLevel) = 0;
    virtual HRESULT SetDimLevel (/* in */ double dimLevel) = 0;
    virtual HRESULT GetMute (/* out */ bool* mute) = 0;
    virtual HRESULT SetMute (/* in */ bool mute) = 0;
    virtual HRESULT CreateIterator (/* in */ REFIID iid, /* out */ LPVOID* ppv) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherFairlightAudioAuxOutputCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherFairlightAudioAuxOutputCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherFairlightAudioAuxOutput () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherFairlightAudioAuxOutputIterator - Fairlight Audio Aux Output Iterator */

class BMD_PUBLIC IBMDSwitcherFairlightAudioAuxOutputIterator : public IUnknown
{
public:
    virtual HRESULT Next (/* out */ IBMDSwitcherFairlightAudioAuxOutput** audioAuxOutput) = 0;

protected:
    virtual ~IBMDSwitcherFairlightAudioAuxOutputIterator () {} // call Release method to drop reference count
};
...
public:
    ...
    virtual HRESULT DoesSupportMicTalkbackGain (/* out */ bool* supportsMicTalkbackGain) = 0;
    virtual HRESULT GetMicTalkbackGain (/* out */ double* gain) = 0;
    virtual HRESULT SetMicTalkbackGain (/* in */ double gain) = 0;
...
public:
    ...
    virtual HRESULT GetProperties (/* out */ BMDSwitcherRecordDiskProperties* diskProperties) = 0;
...
public:
    ...
    virtual HRESULT IsProgramRecordingAvailable (/* out */ bool* recordingAvailable) = 0;
    virtual HRESULT IsISORecordingAvailable (/* out */ bool* available) = 0;
    virtual HRESULT CreateIterator (/* in */ REFIID iid, /* out */ LPVOID* ppv) = 0;
...
/* Interface IBMDSwitcherRemoteSourceConfiguration - Switcher Remote Source Configuration Object */

class BMD_PUBLIC IBMDSwitcherRemoteSourceConfiguration : public IUnknown
{
public:
...
protected:
    virtual ~IBMDSwitcherRemoteSourceConfiguration () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherRemoteSourceConfigurationCallback - Remote Source Configuration Callback Delegate */

class BMD_PUBLIC IBMDSwitcherRemoteSourceConfigurationCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherRemoteSourceConfigurationEventType eventType) = 0;
    virtual HRESULT NotifySource (/* in */ BMDSwitcherRemoteSourceConfigurationSourceEventType sourceEventType, /* in */ uint32_t sourceId) = 0;
};

/* Interface IBMDSwitcherRemoteSource - Switcher Remote Source Object */

class BMD_PUBLIC IBMDSwitcherRemoteSource : public IUnknown
{
public:
    virtual HRESULT GetSourceId (/* out */ uint32_t* sourceId) = 0;
    virtual HRESULT IsLinked (/* out */ bool* linked) = 0;
    virtual HRESULT GetLinkedInput (/* out */ BMDSwitcherInputId* input) = 0;
    virtual HRESULT SetLinkedInput (/* in */ BMDSwitcherInputId input) = 0;
    virtual HRESULT UnlinkInput (void) = 0;
    virtual HRESULT GetName (/* out */ CFStringRef* name) = 0;
    virtual HRESULT GetModelName (/* out */ CFStringRef* model) = 0;
    virtual HRESULT GetEnabled (/* out */ bool* enabled) = 0;
    virtual HRESULT SetEnabled (/* in */ bool enabled) = 0;
    virtual HRESULT GetConnected (/* out */ bool* connected) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherRemoteSourceCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherRemoteSourceCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherRemoteSource () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherRemoteSourceCallback - Remote Source Connected Source Callback Delegate */

class BMD_PUBLIC IBMDSwitcherRemoteSourceCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherRemoteSourceEventType eventType) = 0;
};

/* Interface IBMDSwitcherRemoteSourceIterator - Switcher Remote Source Source Iterator */

class BMD_PUBLIC IBMDSwitcherRemoteSourceIterator : public IUnknown
{
public:
    virtual HRESULT Next (/* out */ IBMDSwitcherRemoteSource** remoteSource) = 0;

protected:
    virtual ~IBMDSwitcherRemoteSourceIterator () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherRemoteSourceExternal - Switcher External Remote Source Source Object */

class BMD_PUBLIC IBMDSwitcherRemoteSourceExternal : public IUnknown
{
public:
    virtual HRESULT GetSourceId (/* out */ uint32_t* sourceId) = 0;
    virtual HRESULT GetKey (/* out */ CFStringRef* key) = 0;
    virtual HRESULT SetKey (/* in */ CFStringRef key) = 0;
    virtual HRESULT GenerateKey (void) = 0;
    virtual HRESULT GetName (/* out */ CFStringRef* name) = 0;
    virtual HRESULT SetName (/* in */ CFStringRef name) = 0;
    virtual HRESULT GetEnabled (/* out */ bool* enabled) = 0;
    virtual HRESULT SetEnabled (/* in */ bool enabled) = 0;
    virtual HRESULT RequestStreamingXML (void) = 0;
    virtual HRESULT GetStreamingXML (/* out */ CFStringRef* xml) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherRemoteSourceExternalCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherRemoteSourceExternalCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherRemoteSourceExternal () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherRemoteSourceExternalCallback - Remote Input External Source Callback Delegate */

class BMD_PUBLIC IBMDSwitcherRemoteSourceExternalCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherRemoteSourceExternalEventType eventType) = 0;
};
...
public:
    ...
    virtual HRESULT GetModelName (/* out */ CFStringRef* model) = 0;
    virtual HRESULT GetStorageMediaInfo (/* in */ int16_t slotIndex, /* out */ CFStringRef* slotName, /* out */ CFStringRef* volumeName) = 0;
...
/* Interface IBMDSwitcherDisplayClockCallback - DisplayClock Object Callback */

class BMD_PUBLIC IBMDSwitcherDisplayClockCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherDisplayClockEventType eventType) = 0;
};

/* Interface IBMDSwitcherDisplayClock - DisplayClock Object */

class BMD_PUBLIC IBMDSwitcherDisplayClock : public IUnknown
{
public:
    virtual HRESULT SetEnabled (/* in */ bool enabled) = 0;
    virtual HRESULT GetEnabled (/* out */ bool* enabled) = 0;
    virtual HRESULT SetOpacity (/* in */ uint16_t opacity) = 0;
    virtual HRESULT GetOpacity (/* out */ uint16_t* opacity) = 0;
    virtual HRESULT SetSize (/* in */ uint16_t size) = 0;
    virtual HRESULT GetSize (/* out */ uint16_t* size) = 0;
    virtual HRESULT SetPositionX (/* in */ double positionX) = 0;
    virtual HRESULT GetPositionX (/* out */ double* positionX) = 0;
    virtual HRESULT SetPositionY (/* in */ double positionY) = 0;
    virtual HRESULT GetPositionY (/* out */ double* positionY) = 0;
    virtual HRESULT SetAutoHide (/* in */ bool autoHide) = 0;
    virtual HRESULT GetAutoHide (/* out */ bool* autoHide) = 0;
    virtual HRESULT SetStartFrom (/* in */ uint8_t hours, /* in */ uint8_t minutes, /* in */ uint8_t seconds, /* in */ uint8_t frames) = 0;
    virtual HRESULT SetStartFromFrames (/* in */ uint32_t frames) = 0;
    virtual HRESULT GetStartFrom (/* out */ uint8_t* hours, /* out */ uint8_t* minutes, /* out */ uint8_t* seconds, /* out */ uint8_t* frames) = 0;
    virtual HRESULT SetClockMode (/* in */ BMDSwitcherDisplayClockMode clockMode) = 0;
    virtual HRESULT GetClockMode (/* out */ BMDSwitcherDisplayClockMode* clockMode) = 0;
    virtual HRESULT GetClockState (/* out */ BMDSwitcherDisplayClockState* state) = 0;
    virtual HRESULT GetClockTime (/* out */ uint8_t* hours, /* out */ uint8_t* minutes, /* out */ uint8_t* seconds, /* out */ uint8_t* frames) = 0;
    virtual HRESULT Start (void) = 0;
    virtual HRESULT Stop (void) = 0;
    virtual HRESULT Reset (void) = 0;
    virtual HRESULT RequestTime (void) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherDisplayClockCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherDisplayClockCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherDisplayClock () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingSourceCallback - Switcher Audio Routing Source Object Callback */

class BMD_PUBLIC IBMDSwitcherAudioRoutingSourceCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherAudioRoutingSourceEventType eventType) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingSourceCallback () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingSource - Switcher Audio Routing Source Object */

class BMD_PUBLIC IBMDSwitcherAudioRoutingSource : public IUnknown
{
public:
    virtual HRESULT GetId (/* out */ BMDSwitcherAudioRoutingSourceId* id) = 0;
    virtual HRESULT GetAudioInputId (/* out */ BMDSwitcherAudioInputId* id) = 0;
    virtual HRESULT GetChannelPair (/* out */ BMDSwitcherAudioChannelPair* pair) = 0;
    virtual HRESULT SetName (/* in */ CFStringRef name) = 0;
    virtual HRESULT GetName (/* out */ CFStringRef* name) = 0;
    virtual HRESULT GetIsNameDefault (/* out */ bool* nameDefault) = 0;
    virtual HRESULT GetExternalPortType (/* out */ BMDSwitcherExternalPortType* type) = 0;
    virtual HRESULT GetInternalPortType (/* out */ BMDSwitcherAudioInternalPortType* type) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherAudioRoutingSourceCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherAudioRoutingSourceCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingSource () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingSourceIterator - Audio Routing Source Iterator */

class BMD_PUBLIC IBMDSwitcherAudioRoutingSourceIterator : public IUnknown
{
public:
    virtual HRESULT Next (/* out */ IBMDSwitcherAudioRoutingSource** input) = 0;
    virtual HRESULT GetById (/* in */ BMDSwitcherAudioRoutingSourceId id, /* out */ IBMDSwitcherAudioRoutingSource** source) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingSourceIterator () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingOutputCallback - Switcher Audio Routing Output Object Callback */

class BMD_PUBLIC IBMDSwitcherAudioRoutingOutputCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherAudioRoutingOutputEventType eventType) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingOutputCallback () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingOutput - Switcher Audio Routing Output Object */

class BMD_PUBLIC IBMDSwitcherAudioRoutingOutput : public IUnknown
{
public:
    virtual HRESULT GetId (/* out */ BMDSwitcherAudioRoutingOutputId* id) = 0;
    virtual HRESULT GetAudioOutputId (/* out */ BMDSwitcherAudioOutputId* id) = 0;
    virtual HRESULT GetChannelPair (/* out */ BMDSwitcherAudioChannelPair* pair) = 0;
    virtual HRESULT SetSource (/* in */ BMDSwitcherAudioRoutingSourceId sourceId) = 0;
    virtual HRESULT GetSource (/* out */ BMDSwitcherAudioRoutingSourceId* sourceId) = 0;
    virtual HRESULT SetName (/* in */ CFStringRef name) = 0;
    virtual HRESULT GetName (/* out */ CFStringRef* name) = 0;
    virtual HRESULT GetIsNameDefault (/* out */ bool* nameDefault) = 0;
    virtual HRESULT GetExternalPortType (/* out */ BMDSwitcherExternalPortType* type) = 0;
    virtual HRESULT GetInternalPortType (/* out */ BMDSwitcherAudioInternalPortType* type) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherAudioRoutingOutputCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherAudioRoutingOutputCallback* callback) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingOutput () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherAudioRoutingOutputIterator - Audio Routing Output Iterator */

class BMD_PUBLIC IBMDSwitcherAudioRoutingOutputIterator : public IUnknown
{
public:
    virtual HRESULT Next (/* out */ IBMDSwitcherAudioRoutingOutput** input) = 0;
    virtual HRESULT GetById (/* in */ BMDSwitcherAudioRoutingOutputId id, /* out */ IBMDSwitcherAudioRoutingOutput** output) = 0;

protected:
    virtual ~IBMDSwitcherAudioRoutingOutputIterator () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherIdentityInformationCallback - Identity Information Callback Delegate */

class BMD_PUBLIC IBMDSwitcherIdentityInformationCallback : public IUnknown
{
public:
    virtual HRESULT Notify (/* in */ BMDSwitcherIdentityInformationEventType eventType) = 0;

protected:
    virtual ~IBMDSwitcherIdentityInformationCallback () {} // call Release method to drop reference count
};

/* Interface IBMDSwitcherIdentityInformation - Identity information retrieval interface */

class BMD_PUBLIC IBMDSwitcherIdentityInformation : public IUnknown
{
public:
    virtual HRESULT GetUniqueId (/* out */ CFStringRef* uniqueId) = 0;
    virtual HRESULT GetIpAddress (/* out */ CFStringRef* ipAddress) = 0;
    virtual HRESULT GetMdnsName (/* out */ CFStringRef* mdnsName) = 0;
    virtual HRESULT GetDeviceName (/* out */ CFStringRef* deviceName) = 0;
    virtual HRESULT AddCallback (/* in */ IBMDSwitcherIdentityInformationCallback* callback) = 0;
    virtual HRESULT RemoveCallback (/* in */ IBMDSwitcherIdentityInformationCallback* callback) = 0;
